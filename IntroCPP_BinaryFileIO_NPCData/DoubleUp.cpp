...
void DoubleUp::DrawVisuals()
{
	...
	DrawLineEx((_paddlePoint + 0)->_position, (_paddlePoint + 1)->_position, (_paddlePoint + 0)->_rec.height * (1 - (_powerTimer / _powerTimeLimit)), RED);
	DrawCircleLines((_paddlePoint + 1)->_position.x, (_paddlePoint + 1)->_position.y, (_paddlePoint + 1)->_rec.height * 1.5, RED);
